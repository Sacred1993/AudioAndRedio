#include <cwchar>
#include "me_xyp_audioandvedio_SimpleLame.h"
#include "lamemp3/lame.h"

static lame_global_flags *glf = NULL;

void Java_me_xyp_audioandvedio_audio_SimpleLame_close(JNIEnv *env, jclass type){
    lame_close(glf);
    glf = NULL;
}

jint Java_me_xyp_audioandvedio_audio_SimpleLame_encode(JNIEnv *env, jclass type, jshortArray buffer_l_,
...
jint Java_me_xyp_audioandvedio_audio_SimpleLame_flush(JNIEnv *env, jclass type, jbyteArray mp3buf_) {
    jbyte *mp3buf = env->GetByteArrayElements(mp3buf_, NULL);
...
void Java_me_xyp_audioandvedio_audio_SimpleLame_init(JNIEnv *env, jclass type, jint inSampleRate, jint outChannel,
